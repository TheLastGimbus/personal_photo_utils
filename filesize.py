#!/usr/bin/env python
# Stolen from https://github.com/jmoiron/humanize/blob/master/src/humanize/filesize.py <3
# I didn't want to add any requirements.txt yet. Their license is MIT.
